...
namespace IsometricGameEngine
{
    public class IsometricUtilities
    {
        ...
        public GridIndex findGridID(IsometricGrid2D isometricGrid, RenderComponent Entity)
        {
        ...
        public GridIndex findGridID(IsometricGrid2D isometricGrid, ColliderComponent Entity)
        {
        ...
        private GridIndex findgridID(IsometricGrid2D isometricGrid, Point Location)
        {
